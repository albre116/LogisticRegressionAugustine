...
```{r}
data <- data.frame(Hospital = c("Center1v2","Center1v2","Center2","Center2","Combined","Combined"),Device = c("FAW_2","FAW1","CFW","FAW","CFW","FAW"),Infections = c(21,11,10,21,3,32),NonInfections = c(656,378,1087,656,368,1034))
